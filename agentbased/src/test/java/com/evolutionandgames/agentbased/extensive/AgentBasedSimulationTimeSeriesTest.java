...
public class AgentBasedSimulationTimeSeriesTest {

	@Test
	public void testSimulateTimeSeries() throws IOException {
...
//		int numberOfTypes = 2;
//		double r= 0.0;
//		RealMatrix gameMatrix = Games.prionersDilemmaEqualGainsFromSwitching();
...
//		simulation.simulateTimeSeries(numberOfTimeSteps, reportEveryTimeSteps, seed, fileName);
